...
public class UserServiceImpl implements UserService {
    ...
    public BankResponse createAccount(UserRequest userRequest) {
        ...
        //Send email Alert
        try {
            EmailUtils.sendEmail(emailClient, savedUser.getFirstName(), savedUser.getLastName(), savedUser.getOtherName(),
                    savedUser.getAccountNumber(), savedUser.getEmail());
            System.out.println("Sending to "+savedUser.getEmail()+" Successful");
        } catch (Exception e) {
            System.out.println("Sending to "+savedUser.getEmail()+" failed");
            e.printStackTrace();
        }
